...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                ...
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="http://trabajofinal.test:90/lugares">Lugares a donde Viajar</a></li>
                    <li><a class="dropdown-item" href="http://trabajofinal.test:90/hoteles">Hoteles</a></li>
                    <li><a class="dropdown-item" href="http://trabajofinal.test:90/contactos">Contactos</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="http://trabajofinal.test:90/tusplanes">Has tu planes ahora!</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://trabajofinal.test:90/comentarios">COMENTARIOS</a>
                </li>
                </ul>
    <header>
